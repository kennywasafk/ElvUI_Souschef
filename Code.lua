...
local function SetupLayout(layout)
	...
	E.db["movers"]["HonorBarMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,6,-205"
	...
	E.db["cooldown"]["expiringColor"]["g"] = 0.25490196078431
  E.db["cooldown"]["expiringColor"]["b"] = 0.25490196078431
	E.db["cooldown"]["hoursColor"]["g"] = 0.9843137254902
	E.db["cooldown"]["hoursColor"]["r"] = 0.55294117647059
	E.db["cooldown"]["secondsColor"]["g"] = 0.85098039215686
	E.db["cooldown"]["secondsColor"]["b"] = 0.47450980392157
	E.db["cooldown"]["daysColor"]["g"] = 0.56078431372549
	E.db["cooldown"]["daysColor"]["r"] = 0.61960784313725
	--Nameplates
	...
	E.db["nameplates"]["units"]["FRIENDLY_NPC"]["healthbar"]["enable"] = false
	...
	E.db["unitframe"]["units"]["focustarget"]["threatStyle"] = "NONE"
	...
	if IsAddOnLoaded("ElvUI_SLE") then
		...
		E.db["sle"]["unitframes"]["unit"]["party"]["dead"]["texture"] = "SKULL2"
		E.db["sle"]["unitframes"]["unit"]["party"]["dead"]["xOffset"] = -40
		E.db["sle"]["unitframes"]["unit"]["party"]["dead"]["size"] = 15
	end
	...
	if IsAddOnLoaded("ElvUI_CustomTweaks") then
		...
		E.db["CustomTweaks"]["CastbarText"]["Focus"]["text"]["xOffset"] = 8
	...
	if layout == "dps" or layout == "tank" then
		...
		E.db["unitframe"]["units"]["targettarget"]["health"]["xOffset"] = -1
		E.db["unitframe"]["units"]["targettarget"]["health"]["text_format"] = "[health:current]"
		E.db["unitframe"]["units"]["targettarget"]["health"]["yOffset"] = 25
		E.db["unitframe"]["units"]["targettarget"]["height"] = 27
	...
	elseif layout == "healer" then
		...
		E.db["movers"]["ElvUF_FocusMover"] = "TOP,ElvUIParent,TOP,235,-428"
    ...
    E.db["movers"]["ElvUF_PetCastbarMover"] = "BOTTOM,ElvUIParent,BOTTOM,-135,393"
		...
		E.db["unitframe"]["units"]["focus"]["health"]["text_format"] = "[health:current]"
		E.db["unitframe"]["units"]["focus"]["health"]["yOffset"] = 28
		E.db["unitframe"]["units"]["focus"]["name"]["yOffset"] = 26
...
local function Filters()
	...
	E.global.nameplate.filters["Explosive Orb"]["actions"]["frameLevel"] = 1
